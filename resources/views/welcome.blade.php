        ...
        <div class="container">
            <div class="extra-margin-container">
                <div class="reservation-inner clearfix">
                    <form action="/reserve" id="form-2" method="post" name="send">
                        @csrf
                        <div class="col-1 c-1">
                        ...
                        <div class="col-2 c-3">
                            <div class="input-wrapper">
                                <label>Date</label>
                                <div class="input-inner input-inner-tel">
                                    <input class="requiredField-r" id="email-"  name="phone_number" placeholder="Phone number" type="text">
                                </div>
                            </div>
                        </div>
                        <div class="col-2 c-4">
                            <div class="select-wrapper">
                                ...
                                <div class="select-inner">
                                    <select class="requiredField-r time select2 select" id="time" name="checkin_time">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-12">
                                                            ...
                                                            <div class="section-txt">
                                                                <p>
                                                                    To create an amicable hospitality environment that maximizes service quality and
                                                                    provide comfort to every customer. Meet and comply with hospitality and hotel industry
                                                                    standards. Provide adequate and advanced modes of communication to support the
                                                                    informational and business needs of customers.
                                                                </p>
                                                            </div>
                                                            <!-- section txt end -->
                                                            <!-- divider start -->
                                                            ...
                                                            <!-- divider end -->
                                                            <p><a class="link-effect" href="tel:+263778661429">Call us at +263778661429</a></p>
                                                            <!-- section txt end -->
                                                            <!-- divider start -->
                                                            <div class="divider-l visible-mobile-devices"></div>
                                                            <!-- divider end -->
...
<div id="parallax-image" class="section-all">
    ...
    <div class="container-fluid">
        ...
        <div class="row">
            ...
            <div class="parallax parallax-all parallax-image-bg-1" data-parallax-speed="0">
                    ...
                    <div class="owl-carousel owl-carousel-testimonials">
                            ...
                            <div class="inner">
                                <div class="quote">
                                    <blockquote class="quote-inner">
                                        Welcome to Enopat Hotel where you will experience hospitality with a difference. Founded
                                        in 2021, we strive to provide exceptional experiences for our guests, while providing an
                                        excellent work environment for our staff and obtaining industry leading results.
                                    </blockquote>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="testimonial testimonial-2">
                            <div class="inner">
                                <div class="quote">
                                    <blockquote class="quote-inner">
                                        Hospitality offers a comprehensive range of services and tools tailor-made to each project to ensure
                                        maximum return on investment to its owners and investors. Enopat Hotel has the
                                        experience needed to lead your on-site team to your hotel’s fullest potential
                                    </blockquote>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="testimonial testimonial-2">
                            <div class="inner">
                                <div class="quote">
                                    <blockquote class="quote-inner">
                                        Set in beautiful surroundings, the recently opened Enopat Hotel is located on the outskirts
                                        of Mutare’s dynamic city centre. A fresh jewel set in luxurious levels of comfort, attention to
                                        detail and superior range of facilities, Enopat is the hotel of preference. Feel surrounded in
                                        modern, stylish and ultimate comfort. Enopat Restaurant also adds to the unique and
...
<script>
    $(document).ready(function() {
        $('#form').submit(function(e) {
            ...
            $.ajax({
                url: '/reserve', // Replace with the correct URL for your Laravel backend
                type: 'POST',
                data: formData,
