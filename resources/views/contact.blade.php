            ...
            <div class="row">
                ...
                <div id="google-maps-wrapper">
                    ...
                    <div class="google-maps">
                        <iframe src="https://maps.google.com/maps/ms?msa=0&amp;msid=211966962386664154949.0004e6fcf6a48ede4754f&amp;hl=en&amp;ie=UTF8&amp;t=m&amp;iwloc=0004e6fcfe81051738dcb&amp;ll=-18.983931994923864%2C32.65690915858336&amp;spn=0,0&amp;z=10&amp;output=embed">
                        </iframe>
                    </div>
                    <!-- google maps end -->
                </div>
                ...
                <div class="center-block-contact-modal">
                    ...
                    <div class="row contact-modal-wrapper">
                        ...
                        <div>
                            <!-- contact form start -->
                            <div id="contact-form">
                                <form action="/send_email" id="form" method="post">
                                    @csrf
                                    <!-- col start -->
