        ...
        <div class="navbar-header fadeIn-element">
            ...
            <div class="logo">
                <a class="navbar-brand logo" href="/">
                    <!-- logo light start -->
{{--                    <img alt="Logo" class="logo-light" style="height: 50px; width: 50px;" src="img/enopat-logo.png">--}}
                    <!-- logo light end -->
                    <!-- logo dark start -->
{{--                    <img alt="Logo" class="logo-dark" style="height: 50px; width: 50px;" src="img/enopat-logo.png">--}}
                    <!-- logo dark end -->
                </a>
            </div>
            <!-- logo end -->
                ...
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu">
                            <li><a class="nav-close" href="/conference">Conference Room</a></li>
                            <li><a class="nav-close" href="/restaurant">Restaurant</a></li>
    ...
    <div class="container-fluid">
        ...
        <div class="row footer-credits">
            ...
            <div class="footer-credits-logo">
                <a href="/"><img alt="Logo Footer" style="width: 150px ; height: 150px" src="img/enopat-logo.png"></a>
            </div>
            <!-- footer logo end -->
            <!-- divider start -->
            <div class="divider-l"></div>
